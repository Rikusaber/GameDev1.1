...
class AssetData {
	...
	public static function initialize():Void {
		...
		if (!initialized) {
			...
			path.set ("assets/images/cavetile.png", "assets/images/cavetile.png");
			type.set ("assets/images/cavetile.png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			path.set ("assets/images/tile3.png", "assets/images/tile3.png");
			type.set ("assets/images/tile3.png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			path.set ("assets/sound/ES_AStrangeDream.mp3", "assets/sound/ES_AStrangeDream.mp3");
			type.set ("assets/sound/ES_AStrangeDream.mp3", Reflect.field (AssetType, "music".toUpperCase ()));
			path.set ("assets/sound/ES_AStrangeDream.ogg", "assets/sound/ES_AStrangeDream.ogg");
			type.set ("assets/sound/ES_AStrangeDream.ogg", Reflect.field (AssetType, "music".toUpperCase ()));
